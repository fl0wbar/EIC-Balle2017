...
from imagecompression.python.ops import coder_ops
from imagecompression.python.ops import math_ops as tfc_math_ops
...
class EntropyBottleneck(base_layer.Layer):
    ...
    def build(self, input_shape):
        ...
        for i in range(len(self.filters) + 1):
            ...
            bias = self.add_variable(
                ...
                initializer=init_ops.RandomUniform(-0.5, 0.5),
            )
        ...
        half = constant_op.constant(0.5, dtype=self.dtype)
        ...
        cdf = coder_ops.pmf_to_quantized_cdf(pmf, precision=self.range_coder_precision)
        ...
        update_op = state_ops.assign(self._quantized_cdf, cdf, validate_shape=False)
    ...
    def visualize(self):
        ...
        with ops.name_scope(self._name_scope()):
            ...
            image = math_ops.cast(image + 0.5, dtypes.uint8)
